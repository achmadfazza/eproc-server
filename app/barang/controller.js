...
module.exports = {
	...
	actionCreate: async (req, res) => {
		try {
			const { name, category, location, reservationdate, endingdate, requirement, description } = req.body;
	...
	actionEdit: async (req, res) => {
		try {
			// coba dulu
			const { id } = req.params;
			const { name, requirement, description, category, location, reservationdate, endingdate } = req.body;
